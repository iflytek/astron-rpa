...
public interface CSmartComponentDao extends BaseMapper<CSmartComponent> {
     ...
     * @return 影响的行数
     */
    @Insert("INSERT INTO c_smart_version (smart_id, smart_type, robot_id, robot_version, content, creator_id, updater_id) " +
    ...
    CSmartComponent getBySmartId(@Param("smartId") String smartId, @Param("robotId") String robotId, @Param("robotVersion") Integer robotVersion);
    ...
    int delete(@Param("robotId") String robotId,
     ...
     * 获取市场上架的流程时，拷贝智能组件数据
     */
    Integer createSmartComponentForObtainedVersion(@Param("obtainedRobotDesign") RobotDesign obtainedRobotDesign,
    ...
    List<CSmartComponent> getAllSmartComponentList(@Param("robotId") String robotId,
