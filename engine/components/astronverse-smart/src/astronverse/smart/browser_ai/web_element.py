...
class WebElement:
    ...
    def find_elements_by_xpath(self, xpath_selector: str, *, timeout=3) -> List[WebElement]:
        ...
        * @return `List[WebElement]`, return the list of the Web elements that match the xpath selector
        ...
        elements = BrowserElement().get_relative_element(browser_obj=self.browser,
    ...
    def input(self, text: str, *, delay_after=0.3) -> None:
        ...
        * @param delay_after, the delay time after the input operation, please specify the value as 0.3, it is important to use this value.
        """
        BrowserElement().input(browser_obj=self.browser, element_data=self.element_data, simulate_flag=True,
                               fill_type=FillInputForFillTypeFlag.Text, fill_input=text, focus_time=100)
    ...
    def click(self, *, delay_after=0.3) -> None:
        ...
        * @param delay_after, the delay time after the click operation, please specify the value as 0.3, it is important to use this value.
        """
        BrowserElement().click(browser_obj=self.browser, element_data=self.element_data, simulate_flag=True,
    ...
    def screenshot(self, folder_path: str, *, filename=None) -> None:
        ...
        * @param filename, the name of the screenshot file, note that the file name cannot contain the following characters: \ / : * ? " < > |
        """
        BrowserElement().screenshot(browser_obj=self.browser, element_data=self.element_data,
                                    folder_path=PATH(folder_path), filename=filename)
    ...
    def set_attribute(self, name: str, value: str) -> None:
        ...
        * @param value, the value of the attribute
        """
        BrowserElement().element_operation(browser_obj=self.browser, element_data=self.element_data,
    ...
    def get_attribute(self, name: str) -> str:
        ...
        * @return `str`, return the str value of the attribute
        """
        return BrowserElement().element_operation(browser_obj=self.browser, element_data=self.element_data,
    ...
    def parent(self) -> WebElement:
        ...
        * @return `WebElement`, return the parent WebElement object
        ...
        elements = BrowserElement().get_relative_element(browser_obj=self.browser,
                                                         element_data=self.element_data,
                                                         relative_type=RelativeType.Parent
                                                         )
    ...
    def child_at(self, index) -> WebElement:
        ...
        * @return `WebElement`, return the child WebElement object at the specified index
        """
        element = BrowserElement().get_relative_element(browser_obj=self.browser,
                                                        element_data=self.element_data,
                                                        relative_type=RelativeType.Child,
    ...
    def slider_hover(self, progress_element: WebElement, percent_value: float = 0.0, 
                     drag_direction: str = "right", drag_type: str = "start", duration: float = 0.25) -> None:
        """
        滑块拖拽操作
        ...
        * @param duration, 拖拽持续时间
        ...
        type_map = {
            "start": ElementDragTypeFlag.Start,
            "current": ElementDragTypeFlag.Current
        }
