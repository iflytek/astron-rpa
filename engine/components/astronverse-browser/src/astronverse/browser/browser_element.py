...
class BrowserElement:
    ...
    def get_table(
        ...
        if browser_obj.browser_type in CHROME_LIKE_BROWSERS:
            ...
            # 定位
            Locator.locator(element_data.get("elementData"), cur_target_app=browser_obj.browser_type.value)
            # 元素
    ...
    def data_batch(
        ...
        for i in range(1, page_count + 1):
            ...
            if produce_type == "table":
                ...
                # 定位
                Locator.locator(batch_element, cur_target_app=browser_obj.browser_type.value)
                # 发送给插件
