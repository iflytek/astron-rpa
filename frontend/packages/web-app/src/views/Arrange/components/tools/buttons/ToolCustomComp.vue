...
<template>
  <ToolButton v-if="show" :tooltip="$t('components.customComponentSetting')" :label="$t('components.customComponentSetting')" icon="tools-custom-comp-setting" :class="['_tools-custom-comp-setting']" @click="handleClick" />
</template>
