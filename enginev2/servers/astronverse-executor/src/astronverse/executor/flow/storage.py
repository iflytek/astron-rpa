...
class HttpStorage(Storage):
    ...
    def __http__(
        self, shot_url: str, params: Optional[dict], data: Optional[dict], meta: str = "post", has_code=True
    ) -> Any:
        """post 请求"""
        cookies = {}
    ...
    def get_remote_var_value(self, key: str) -> dict:
        ...
        res = self.__http__("/api/robot/robot-shared-var/get-batch-shared-var", None, {"ids": [key]}, "post", True)
        if res:
